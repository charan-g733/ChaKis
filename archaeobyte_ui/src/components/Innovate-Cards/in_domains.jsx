    ...
    <div className="u-card-domains">
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          ...
          <p>Skills you'll gain: Java, Springboot, Console based application & More....</p>
          <div className="u-rating">
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          ...
          <p>Skills you'll gain: React/Angular, Express, Node, Mongo/SQL & More.....</p>
          <div className="u-rating">
            <span className="u-rating-value">4.9</span>
            <span className="u-rating-star">★</span>
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          <h4>Data Science</h4>
          <p>Skills you'll gain: Python, Machine Learning, Data Visualization, SQL...</p>
          <div className="u-rating">
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          ...
          <p>Skills you'll gain: Machine Learning, ML Models, Prediction & classification, & More.....</p>
          <div className="u-rating">
            <span className="u-rating-value">4.8</span>
            <span className="u-rating-star">★</span>
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          <h4>UX Design</h4>
          <p>Skills you'll gain: UX Design, Adobe, Figma tool, Designing & More....</p>
          <div className="u-rating">
            <span className="u-rating-value">4.9</span>
            <span className="u-rating-star">★</span>
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          ...
          <p>Skills you'll gain: Android IDE, XML, Java/Kotlin, SQLLite Helper class & More....</p>
          <div className="u-rating">
            <span className="u-rating-value">4.8</span>
            <span className="u-rating-star">★</span>
            <span className="u-rating-text">(173K reviews)</span>
          </div>
          <p className="u-rating-description">Inytermediate · Virtual Internship  1 month</p>
        </div>
      </div>
      <div className="u-card">
        ...
        <div className="u-card-details">
          ...
          <p>Skills you'll gain: AWS EC2, S3, Dynamo DB, Management Console, & More.....</p>
          <div className="u-rating">
            <span className="u-rating-value">5.0</span>
            <span className="u-rating-star">★</span>
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          <h4>DevOps on AWS</h4>
          <p>Skills you'll gain: AWS Console, DevOps, Jenkins, GitHub & More....</p>
          <div className="u-rating">
            <span className="u-rating-value">4.6</span>
            <span className="u-rating-star">★</span>
            <span className="u-rating-text">(299K reviews)</span>
          </div>
          <p className="u-rating-description">Intermediate · Virtual Internship  1 month</p>
        </div>
      </div>
      <div className="u-card">
      ...
      <div className="u-card">
        ...
        <div className="u-card-details">
          <h4>Deep Learning</h4>
          <p>Skills you'll gain: Deep Learning Models, NPL, CNN's, Keras & More....</p>
          <div className="u-rating">
