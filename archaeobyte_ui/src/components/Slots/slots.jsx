      ...
      <div className="custom-cards">
        <div className="custom-card">
          ...
          <div className="custom-card-body">
            ...
            <button className="custom-card-button">Register for Internship Program</button>
          </div>
        </div>
        <div className="custom-card">
          <div className="custom-card-header">
            <img src="images/slots2.png" alt="Intensive 3.0" className="custom-image" />
          ...
          <div className="custom-card-body">
            ...
            <div className="custom-card-title">
              Master the Right skill you deserve and become Market Ready Software Engineer
            </div>
            <button className="custom-card-button">Register for Free Master class</button>
          </div>
        </div>
      </div>
    </div>
