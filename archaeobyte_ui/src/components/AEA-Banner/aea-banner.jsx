                ...
                <div className="education-banner-text">
                    ...
                    <div className="education-banner-courses">
                        <div className="education-banner-course">
                            <h3>Training</h3>
                            <p> Get certified Training by IBM, Infosys, Nasscom with Top Mentorship support </p>
                        </div>
                        <div className="education-banner-divider"></div>
                        <div className="education-banner-course">
                            <h3>Internship</h3>
                            <p>Apply your skills and gain In-Hand Experience in our Internship Program. </p>
                        </div>
                        <div className="education-banner-divider"></div>
                        <div className="education-banner-course">
