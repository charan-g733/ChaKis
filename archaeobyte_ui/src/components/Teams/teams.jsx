        ...
        <div className="bussiness-inner-container">
          <div>
            ...
            <div className="bussiness-benefits">
              ...
              <ul>
                <li>
                  Train your entire workforce with all Leading Edge
                  Technologies.
                </li>
                <li>
                  Prep employees for industry-recognized certification exams
                </li>
                <li>
                  Develop highly skilled tech teams in a professional
                  environment
                </li>
                <li>
